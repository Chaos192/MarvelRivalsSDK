...
public:
	...
	TMulticastInlineDelegate<void(const struct FEventPointConfig& event_point)> TriggerEventPoint;   // 0x0808(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, BlueprintCallable, NativeAccessSpecifierPublic)
