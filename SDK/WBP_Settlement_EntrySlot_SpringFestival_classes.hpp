...
// WidgetBlueprintGeneratedClass WBP_Settlement_EntrySlot_SpringFestival.WBP_Settlement_EntrySlot_SpringFestival_C
// 0x10C8 (0x1860 - 0x0798)
class UWBP_Settlement_EntrySlot_SpringFestival_C final : public UPyWidget_SettlementData_Slot
{
public:
...
public:
	void ExecuteUbergraph_WBP_Settlement_EntrySlot_SpringFestival(int32 EntryPoint);
	void PreConstruct(bool IsDesignTime);

public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"WBP_Settlement_EntrySlot_SpringFestival_C">();
	}
	static class UWBP_Settlement_EntrySlot_SpringFestival_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UWBP_Settlement_EntrySlot_SpringFestival_C>();
	}
};
