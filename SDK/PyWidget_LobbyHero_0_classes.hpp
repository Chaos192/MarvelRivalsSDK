...
public:
	...
	TMulticastInlineDelegate<void(int32 HeroID, const struct FVector2D& Circle, const struct FVector2D& Target, float Max_R)> OnHoveredPosition; // 0x0780(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, BlueprintCallable, NativeAccessSpecifierPublic)
