...
struct WBP_HeroSystem_SkinItem_C_BP_OnItemExpansionChanged final
{
public:
...
// 0x0001 (0x0001 - 0x0000)
struct WBP_HeroSystem_SkinItem_C_BP_OnItemSelectionChanged final
{
public:
...
struct WBP_HeroSystem_SkinItem_C_OnListItemObjectSet final
{
public:
