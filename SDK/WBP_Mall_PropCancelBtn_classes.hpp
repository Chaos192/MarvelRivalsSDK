...
// Package: WBP_Mall_PropCancelBtn
...
// WidgetBlueprintGeneratedClass WBP_Mall_PropCancelBtn.WBP_Mall_PropCancelBtn_C
// 0x0050 (0x0940 - 0x08F0)
class UWBP_Mall_PropCancelBtn_C final : public UPyWidget_CommonButton_Lv1
{
public:
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"WBP_Mall_PropCancelBtn_C">();
	}
	static class UWBP_Mall_PropCancelBtn_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UWBP_Mall_PropCancelBtn_C>();
	}
};
