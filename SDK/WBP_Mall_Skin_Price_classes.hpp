...
// WidgetBlueprintGeneratedClass WBP_Mall_Skin_Price.WBP_Mall_Skin_Price_C
// 0x0020 (0x0830 - 0x0810)
class UWBP_Mall_Skin_Price_C final : public UPyWidget_MallPrice
{
public:
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"WBP_Mall_Skin_Price_C">();
	}
	static class UWBP_Mall_Skin_Price_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UWBP_Mall_Skin_Price_C>();
	}
};
